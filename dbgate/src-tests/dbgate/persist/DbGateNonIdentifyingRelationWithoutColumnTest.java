...
import dbgate.persist.support.nonidentifyingrelationwithoutcolumn.Currency;
import dbgate.persist.support.nonidentifyingrelationwithoutcolumn.Product;
 ...
 * Time: 6:40:58 PM
 */
public class DbGateNonIdentifyingRelationWithoutColumnTest extends AbstractDbGateTestBase
{
    ...
    {
        testClass = DbGateNonIdentifyingRelationWithoutColumnTest.class;
        beginInit(dbName);

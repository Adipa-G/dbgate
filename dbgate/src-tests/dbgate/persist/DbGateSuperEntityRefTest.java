...
import dbgate.persist.support.superentityrefinheritance.*;
...
public class DbGateSuperEntityRefTest extends AbstractDbGateTestBase
{
    ...
    private SuperEntityRefRootEntity createDefaultRootEntity(int id,int typeACount,int typeBCount,boolean one2OneIsA,boolean one2OneIsB) throws
    DbGateException
    {

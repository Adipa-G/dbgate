...
import dbgate.*;
import dbgate.persist.support.inheritancetest.*;
 ...
 * Time: 6:40:58 PM
 */
public class DbGateInheritancePersistTest extends AbstractDbGateTestBase
{
    ...
    {
        testClass = DbGateInheritancePersistTest.class;
        beginInit(dbName);

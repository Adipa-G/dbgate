...
public class ERManagementChangeTrackerTest
{
    ...
    public static void before()
    {
        try
        {
            Logger.getLogger(ERManagementChangeTrackerTest.class.getName()).info("Starting in-memory database for unit tests");
        ...
        {
            ex.printStackTrace();
            Logger.getLogger(ERManagementChangeTrackerTest.class.getName()).severe("Exception during database startup.");
        }
    }
    ...
    {
        Logger.getLogger(ERManagementChangeTrackerTest.class.getName()).info("Stopping in-memory database.");
        try
        {

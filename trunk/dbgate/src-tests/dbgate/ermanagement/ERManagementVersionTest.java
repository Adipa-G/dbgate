...
public class ERManagementVersionTest
{
    ...
    public static void before()
    {
        try
        {
            Logger.getLogger(ERManagementVersionTest.class.getName()).info("Starting in-memory database for unit tests");
        ...
        {
            ex.printStackTrace();
            Logger.getLogger(ERManagementVersionTest.class.getName()).severe("Exception during database startup.");
        }
    }
    ...
    {
        Logger.getLogger(ERManagementVersionTest.class.getName()).info("Stopping in-memory database.");
        try
        {

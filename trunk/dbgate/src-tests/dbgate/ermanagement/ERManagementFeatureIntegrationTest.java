...
import dbgate.ermanagement.support.persistant.featureintegration.product.Service;
...
public class ERManagementFeatureIntegrationTest
{
    ...
    public static void before()
    {
        try
        {
            Logger.getLogger(ERManagementFeatureIntegrationTest.class.getName()).info("Starting in-memory database for unit tests");
        ...
        {
            ex.printStackTrace();
            Logger.getLogger(ERManagementFeatureIntegrationTest.class.getName()).severe("Exception during database startup.");
        }
    }
    ...
    {
        Logger.getLogger(ERManagementFeatureIntegrationTest.class.getName()).info("Stopping in-memory database.");
        try
        {

...
{
    @ColumnInfo(columnType = ColumnType.INTEGER,key = true,readFromSequence = true,sequenceGeneratorClassName = "dbgate.support.persistant.columntest.PrimaryKeyGenerator")
    private int idCol;

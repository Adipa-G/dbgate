...
import dbgate.VerifyOnWriteStrategy;
import dbgate.patch.support.patchtabledifferences.FourColumnEntity;
import dbgate.patch.support.patchtabledifferences.ThreeColumnEntity;
import dbgate.patch.support.patchtabledifferences.ThreeColumnTypeDifferentEntity;
 ...
 * Time: 6:40:58 PM
 */
public class DbGatePatchTableDifferenceDBTest extends AbstractDbGateTestBase
{
    ...
    {
        testClass = DbGatePatchTableDifferenceDBTest.class;
